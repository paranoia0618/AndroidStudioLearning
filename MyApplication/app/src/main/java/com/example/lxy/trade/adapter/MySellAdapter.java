package com.example.lxy.trade.adapter;
...
public class MySellAdapter extends BaseAdapter implements View.OnClickListener {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        if(view==null){
            ...
            view=inflater.inflate(com.example.lxy.trade.R.layout.item_mysell,null);
            viewHolder1.mysell_tv_title=(TextView)view.findViewById(com.example.lxy.trade.R.id.mysell_item_title);
            viewHolder1.mysell_iv_modify=(ImageView)view.findViewById(com.example.lxy.trade.R.id.mysell_item_modify);
            viewHolder1.mysll_iv_delete=(ImageView) view.findViewById(com.example.lxy.trade.R.id.mysell_item_delete);
            //设置缓存
